...
public class ConvertArray {
     ...
     * 
     * When last argument is true, the comparison assumes the MSB is at 
     * the highest index position, and when it's false, the contrary; 
     * that is MSB at [0].
     *
    ...
    /**
     * See if the byte array contains just (ASCII) text
