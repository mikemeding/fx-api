/*
 * Copyright (c) 2012 OutSmart Power Systems -- All Rights Reserved.
 */
...
/**
 * Hash Map which uses primitive long as key. Main advantage is new instance of
 * Long does not have to be created for each lookup.
 */
public class LongHashMap<V> implements Serializable {
	...
	/**
	 * Create a hash key from a long
	 * @param key is the key
	 * @return  the hash value
	 */
	private static int powerHash(final long key) {
