...
public class ByteHelper {
	...
	/**
	 * Converts a byte array that represents an unsigned 8-bit integer
	 */
	...
	/**
	 * Converts a byte array that represents an unsigned 16-bit integer
	 */
	...
	/**
	 * Converts a byte array into an octal String like: \003\005\...
	 */
	...
	/**
	 * Converts a String to a byte array using ASCII translation. This method
	 * allocates a single byte per character so it is NOT possible to encode
	...
	/**
	 * Converts a byte array that represents a String Assumes ASCII translation.
	 */
	 ...
	 * pattern. This implements the Knuth-Morris-Pratt pattern matching
	 * algorithm.
	 */
	...
	/**
	 * Converts an InetAddress to a byte Array. IPv4 Addresses producte 4 bytes.
	 * IPv6 Addresses produce 16 bytes.
	 */
	...
	/**
	 * Convert the content of a byte buffer to a string, using a default char
	 * encoding
	 *
	 * @param buf is the byte buffer
	 * @return a string
	...
	/**
	 * Allocate a body buffer, depending on size we will either do this in
