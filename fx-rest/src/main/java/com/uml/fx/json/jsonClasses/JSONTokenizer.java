...
package com.uml.fx.json.jsonClasses;
...
public class JSONTokenizer {
    ...
    public Object nextValue() throws JSONException {
        ...
        switch (c) {
            ...
            case '{':
                back();
				return new JSONParser(this).parseObject();
            case '[':
            case '(':
                back();
				return new JSONParser(this).parseArray();
        }
        ...
        return JSONHelper.stringToValue(s);
    }
